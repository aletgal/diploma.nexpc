...
// Maps parsed filter URL params → spec path + search term
...
// Smart sort: numeric for size/speed values
...
const getProducts = async (req, res, next) => {
  try {
    ...
    // Parsed spec filters (CPU_BRAND, GPU_VRAM, etc.)
    ...
    // Legacy dynamic spec filters (unknown params not in KNOWN_PRODUCT_PARAMS)
...
const getProduct = async (req, res, next) => {
  try {
    ...
    // Auto-link components by matching spec values against component names
